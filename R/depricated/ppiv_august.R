...
out[1,1] <- do_rf("ldwell", user_factors = "features", name = "subject_features")
...
out[1,4] <- do_rf("ldwell",  user_factors = "features", item_factors = "features", name = "subject_features_headline_features")
out[1,5] <- do_rf("ldwell", user_factors = "features",environment_factors = "features", name = "subject_features_environment_features")
out[1,6] <- do_rf("ldwell",  environment_factors = "features", item_factors = "features", name = "environment_features_headline_features")
out[1,7] <- do_rf("ldwell",  user_factors = "features",environment_factors = "features", item_factors = "features", name = "subject_features_headline_features_environment_features")

out[2,1] <- do_rf("response", user_factors = "features", name = "subject_features")
out[2,2] <- do_rf("response", item_factors = "features", name = "headline_features")
out[2,3] <- do_rf("response", environment_factors = "features", name = "enviornment_features")
out[2,4] <- do_rf("response",  user_factors = "features", item_factors = "features", name = "subject_features_headline_features")
out[2,5] <- do_rf("response", user_factors = "features",environment_factors = "features", name = "subject_features_environment_features")
out[2,6] <- do_rf("response",  environment_factors = "features", item_factors = "features", name = "environment_features_headline_features")
out[2,7] <- do_rf("response",  user_factors = "features",environment_factors = "features", item_factors = "features", name = "subject_features_headline_features_environment_features")
...
full_dwell <- do_rf("ldwell",  user_factors = "features",environment_factors = "features", item_factors = "features", return_model = T)
full_share <- do_rf("response",  user_factors = "features",environment_factors = "features", item_factors = "features", return_model = T)
full_share2 <- do_rf("response",  user_factors = "features",environment_factors = "features", item_factors = "dummies", return_model = T)
par(mfrow=c(1,2))
